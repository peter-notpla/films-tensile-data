"""Replay shared/friction_parser.py against every real processed friction
...
Usage: python3 shared/verify_friction_parser.py
"""
...
def load_manifest_by_checksum():
    ...
    query = """
        ...
        WHERE pipeline = 'friction' AND status = 'success'
...
def main():
    print("Loading manifest (pipeline=friction, status=success)...")
    ...
    print(f"Found {len(blobs)} processed friction CSVs to replay.\n")
